...
//import com.rainsoil.common.data.mybatis.IBaseVoService;
...
// * @since 2021/12/9
// **/
//public class BaseVoServiceImpl<M extends BaseMapperPlus<T>, T, V> extends AbstractBaseServiceImpl<M, T> implements IBaseVoService<T, V> {
//
//	@Override
