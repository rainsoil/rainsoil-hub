...
public class SwaggerAddtion implements ApiListingScannerPlugin {
	...
	public List<ApiDescription> apply(DocumentationContext context) {
		Operation usernamePasswordOperation = new OperationBuilder(new CachingOperationNameGenerator())
				...
				.consumes(CollectionUtil.newHashSet(MediaType.APPLICATION_FORM_URLENCODED_VALUE)) // 接收参数格式
				.produces(CollectionUtil.newHashSet(MediaType.APPLICATION_JSON_VALUE)) // 返回参数格式
				.tags(CollectionUtil.newHashSet("登录"))
