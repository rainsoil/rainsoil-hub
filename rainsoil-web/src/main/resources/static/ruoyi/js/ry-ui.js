    ...
    $.extend({
        ...
        table: {
            ...
            queryParams: function (params) {
                ...
                $.extend(p, $.common.formToJSON(currentId));
        ...
        treeTable: {
            ...
            responseHandler: function (res) {
                ...
                if (res.status != undefined && res.status != web_status.SUCCESS) {
                    $.modal.alertWarning(res.msg);
                    return [];
                } else {
                    return res;
        ...
        operate: {
            ...
            ajaxSuccess: function (result) {
                if (result.status == web_status.SUCCESS && table.options.type == table_type.bootstrapTable) {
                    ...
                    $.modal.msgSuccess(result.msg);
                    $.treeTable.refresh();
                } else if (result.status == web_status.SUCCESS && $.common.isEmpty(table.options.type)) {
                    $.modal.msgSuccess(result.msg)
                } else if (result.status == web_status.WARNING) {
                    $.modal.alertWarning(result.msg)
                } else {
        ...
        validate: {
            ...
            unique: function (value) {
                if (JSON.parse(value).status == web_status.SUCCESS) {
                    return true;
                }
                return false;
            },
